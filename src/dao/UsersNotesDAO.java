...
public interface UsersNotesDAO {
	...
	/**
	 *Gets all the UsersNotes that are related to an user and they are in trash
	 * 
	 * @param idu
	 *            User identifier
	 * 
	 * @return List of all the UsersNotes that an user can access (only in trash).
	 */
	...
	/**
	 * Deletes all userNotes of the user which are in trash
	 *            
	 * @param idu
	 *            User Identifier
	 * 
