...
public interface NoteDAO {
	...
	/**
	 * Gets all the notes from the database that contain that color.
	 * 
	 * @param color
	 *            color that we want to search .
	 * 
	 * @return List of all the notes from the database that contain that color.
	 */	
